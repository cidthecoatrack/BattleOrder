...
namespace BattleOrder.Core.Models.Actions
{
    ...
    public class BattleAction
    {
        ...
        public Int32 Remaining { get { return ThisRound - currentPartOfAction; } }
        ...
        public void FinishCurrentPartOfAction()
        {
            ...
            if (HasDifferingPerRound() && ActionIsDone())
                allUsable = !allUsable;
        }

        private Boolean HasDifferingPerRound()
        {
            return (PerRound - Math.Floor(PerRound)) > 0;
        }
