...
namespace BattleOrder.Tests.Models.Actions
{
    ...
    public class BattleActionTests
    {
        ...
        [Test]
        public void ActionsUsedGivesAccurateCount()
        {
            FinishActions(3);
        ...
        [Test]
        public void ActionsLeftGivesAccurateCount()
        {
            FinishActions(3);
            Assert.That(action.Remaining, Is.EqualTo(2));
        }

        [Test]
        public void ActionsLeftShowUpperPerRoundIfAllUsable()
        {
        ...
        [Test]
        public void ActionsLeftShowLowerPerRoundIfNotAllUsable()
        {
            action.AlterInfo(action.Name, 4.5, action.Speed);
            FinishActions(5);
            action.PrepareForNextRound();
            FinishActions(3);
            Assert.That(action.Remaining, Is.EqualTo(1));
        }

        [Test]
        public void ActionIsValid()
        {
